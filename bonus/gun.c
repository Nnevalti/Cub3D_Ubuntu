...
{
	if (ennemy == 9)
		system("ffplay Musics/death.mp3 -nodisp -loglevel quiet &");
	if (ennemy == 8)
		system("ffplay Musics/wilhem.mp3 -nodisp -loglevel quiet &");
	if (ennemy == 3 || ennemy == 4)
		system("ffplay Musics/stupid.mp3 -nodisp -loglevel quiet &");
	if (ennemy == 2)
		system("ffplay Musics/barrel.mp3 -nodisp -loglevel quiet &");
	if (ennemy == 4 || ennemy == 5)
		system("ffplay Musics/off.mp3 -nodisp -loglevel quiet &");
	if (ennemy == 6)
		system("ffplay Musics/done.mp3 -v 3 -nodisp -loglevel quiet &");
}
